...
import { Subject, timer, fromEvent, merge, of, animationFrameScheduler, Observable, from } from 'rxjs';
import { take, distinctUntilChanged, filter, map, pairwise, share, skip, throttleTime, catchError, mergeMap } from 'rxjs/operators';
import { CommonModule, isPlatformBrowser, DOCUMENT as DOCUMENT$1, isPlatformServer } from '@angular/common';
import { NG_VALUE_ACCESSOR, FormsModule, NG_VALIDATORS, FormControl, NgModel } from '@angular/forms';
import { Component, ElementRef, Renderer2, Input, HostBinding, NgModule, Directive, HostListener, forwardRef, ChangeDetectionStrategy, ViewEncapsulation, ViewChild, Injectable, Output, EventEmitter, Inject, PLATFORM_ID, ChangeDetectorRef, ContentChildren, isDevMode, Injector, TemplateRef, RendererFactory2, ApplicationRef, ComponentFactoryResolver, NgZone, ViewContainerRef, Attribute, NO_ERRORS_SCHEMA, ContentChild, Host, InjectionToken, Optional, ViewChildren, SkipSelf, SecurityContext, defineInjectable } from '@angular/core';
...
class SBItemBodyComponent {
    ...
    openSidenavOnActiveLink() {
        /** @type {?} */
        const pathStrategyUrl = win.location.pathname;
        /** @type {?} */
        const hashStrategyUrl = win.location.hash;
        /** @type {?} */
...
class SelectComponent {
    ...
    updateDropdownHeight() {
        /** @type {?} */
        const customContentHeight = this.dropdown ? this.dropdown.customContent.nativeElement.clientHeight : 0;
...
class MdbMultiRangeInputComponent {
    /**
     * @param {?} renderer
     */
...
class SidenavComponent {
     ...
     */
    ngOnInit() {
        if (this.sidenavBreakpoint && this.sidenavBreakpoint >= win.innerWidth) {
            this.hide();
        }
    }
    /**
